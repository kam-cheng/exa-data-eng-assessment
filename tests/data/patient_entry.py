"""Example of a FHIR Patient Entry from a FHIR Bundle file."""
PATIENT_ENTRY = {
    ...
    'resource': {'resourceType': 'Patient',
                  ...
                  {'type':
                   ...
                   'value': '999-86-2571'},
                     {'type':
                      {'coding':
                       [{'system': 'http://terminology.hl7.org/CodeSystem/v2-0203',
                         'code': 'DL', 'display': "Driver's License"}],
                 ...
                 'address': [{'extension':
                              [{'url': 'http://hl7.org/fhir/StructureDefinition/geolocation',
                                'extension': [{'url': 'latitude', 'valueDecimal': 42.13509612101196},
                                              {'url': 'longitude', 'valueDecimal': -71.94977170576706}]}],
